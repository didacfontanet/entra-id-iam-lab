...
Most IAM candidates have certifications but no visible proof of hands-on work. This repo bridges that gap — every lab is something I configured, tested, troubleshot, and documented myself, with real screenshots from my own tenant. The design decisions explain *why*, not just *how*.
